...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP ENVIRONMENT - PYTHON3 LIBRARIES FOR DRYES PACKAGE'
script_version="1.0.0"
script_date='2021/09/16'
...
fp_env_file_reference_default='fp_virtualenv_python3_dryes_settings'
fp_env_folder_libraries_default='fp_virtualenv_python3_dryes_libraries'

fp_env_file_requirements_default='requirements_fp_env_python_dryes.yaml'
